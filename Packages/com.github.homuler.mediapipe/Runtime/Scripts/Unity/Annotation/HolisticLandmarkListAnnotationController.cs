...
namespace Mediapipe.Unity
{
  public class HolisticLandmarkListAnnotationController : AnnotationController<HolisticLandmarkListAnnotation>
  {
    ...
    public IReadOnlyList<NormalizedLandmark> _currentFaceLandmarkList;
    public IReadOnlyList<NormalizedLandmark> _currentPoseLandmarkList;
    public IReadOnlyList<NormalizedLandmark> _currentLeftHandLandmarkList;
    public IReadOnlyList<NormalizedLandmark> _currentRightHandLandmarkList;
